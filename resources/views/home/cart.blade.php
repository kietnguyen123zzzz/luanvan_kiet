                        ...
                        <tr class="row_cart form-group ">
                            ...
                            <td class="px-6 py-3 whitespace-nowrap">
                                <div class="flex gap-5" id="test">
                                    ...
                                    <div class="cart-qty">
                                        <input style="width: 100px; margin: 0 auto" type="number" data-id="1186"
                                            data-rowid="c47ebecd28dc8e70b29c26e1c7062152" data-store_id="" onChange="updateCart($(this));"
                                            class="item-qty form-control" id="item-qty" name="qty-1186" value="1">
                                    </div>
